...
> Scanned: 120256 jobs from 4269 sources (4264 ATS boards polled, 46 newly discovered)
...
- workable: HTTP 429 — 41 boards (e.g. 10xbanking, 1000heads, 1915-south-ashley); will retry next run
