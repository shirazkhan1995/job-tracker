...
> Scanned: 99103 jobs from 3310 sources (3305 ATS boards polled, 63 newly discovered)
...
- workable: HTTP 429 — 37 boards (e.g. 10xbanking, 1000heads, 1915-south-ashley); will retry next run
