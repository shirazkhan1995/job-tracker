...
> Scanned: 113236 jobs from 4078 sources (4073 ATS boards polled, 122 newly discovered)
...
- workable: HTTP 429 — 4 boards (e.g. 10xbanking, 1000heads, 1915-south-ashley); will retry next run
